...
<div class="box">
   <p>Reset Password</p>
  <form  class="px-4 py-3" action="ResetPasswordServlet" method="post">
    <div class="mb-3">
       
      <input type="text" class="form-control" disabled   required placeholder="<%=session.getAttribute("username") %>"  id="exampleDropdownFormEmail1" placeholder="email@example.com">
    </div>
    ...
    <button type="submit" id="but" aria-disabled="true"  class="btn btn-primary">Submit</button>
    <br>
    <br>
